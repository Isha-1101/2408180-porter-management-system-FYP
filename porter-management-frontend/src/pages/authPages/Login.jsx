...
//   return (
//     <div className="min-h-[calc(100vh-5rem)] h-30 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen  flex items-center justify-center p-4 relative overflow-hidden">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 z-10">
        ...
        >
          <div className="relative h-full w-full rounded-full overflow-hidden shadow-2xl">
            <div
              ...
              style={{
                // backgroundImage: "url('/images/doko_namlo.png')",
                backgroundColor: "#1c5493",
              }}
            >
        ...
        >
          <div className="w-full max-w-md bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-white/20">
            {/* Form Header */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    type="button"
                    variant="outline"
                    className="h-11 rounded-lg border-gray-300 hover:bg-gray-50"
                  >
