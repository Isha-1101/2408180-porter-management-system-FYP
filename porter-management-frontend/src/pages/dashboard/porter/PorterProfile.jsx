...
const PorterProfile = () => {
    ...
    // Personal info (from PorterBasicInfo sub-doc)
    const basicInfo = porter.basicInfo || {};
    const { fullName, phone, address, porterPhoto, identityType, identityNumber } = basicInfo;
    ...
    // Vehicle (from PorterVehicle sub-doc)
    const vehicle = porter.vehicle || null;

    // Document (from PorterDocument sub-doc)
                                ...
                                <div className="pt-4 space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        {identityCardImageFront && (
                                            <div className="space-y-1">
                                                <p className="text-xs text-gray-400 font-medium">Front Side</p>
                                                <img
                                        ...
                                        {identityCardImageBack && (
                                            <div className="space-y-1">
                                                <p className="text-xs text-gray-400 font-medium">Back Side</p>
                                                <img
                    ...
                    <Card className="shadow-sm">
                        ...
                        <CardContent>
                            ...
                            {docInfo.porterLicenseDocument && (
                                <div className="pt-3">
                                    <DocImage
                                        src={docInfo.porterLicenseDocument ? getCloudinaryUrl(docInfo.porterLicenseDocument) : null}
                    ...
                    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-gray-400 mt-0.5">Only phone and address can be updated.</p>
                            </div>
                            <button
                                onClick={() => setEditOpen(false)}
                        ...
                        <div className="space-y-1.5">
                            <Label htmlFor="edit-phone" className="text-sm font-medium flex items-center gap-2 text-gray-700">
                        ...
                        {/* Address */}
                        <div className="space-y-1.5">
                            <Label htmlFor="edit-address" className="text-sm font-medium flex items-center gap-2 text-gray-700">
