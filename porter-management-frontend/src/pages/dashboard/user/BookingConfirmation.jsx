                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="flex items-center gap-4 border p-4 rounded-lg">
                            ...
                            <div className="text-right">
                                <p className="font-bold text-xl text-primary">NPR {basePrice}</p>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    <span className="text-muted-foreground">Porter Base Fare</span>
                                    <span>NPR {basePrice}</span>
                                </div>

                                <div className="flex justify-between">
                                    <span className="text-muted-foreground">
                                        Weight Charge ({extraWeight > 0 ? `${extraWeight}kg x NPR ${pricePerKg}` : 'Included'})
                                    </span>
