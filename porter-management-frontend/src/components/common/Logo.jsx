export default function Logo({ className = "", text = false }) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      {/* Logo Icon */}
      <div className="relative inset-0 bg-cover bg-center w-9 h-9 bg-primary rounded-full flex items-center justify-center text-primary-foreground font-bold text-xl">
